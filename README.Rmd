...
The goal of peer is to provide easy access to useful [{rgee}](https://r-spatial.github.io/rgee/) functions - like composites etc.

## Installation

You can install the development version of peerm from [GitHub](https://github.com/):

first clone the library - SSH probably best option. Then open the project and run
the following in R:
